...
const services = [
    {
        ...
        description: 'Descrever uma descrição sobre o trabalho em desenvolvimeto web.',
        href: ""
    },
    {
        num: '02',
...
export default function Services() {
    return(
        <section>
            <div className="container mx-auto min-h-[80vh] flex flex-col justify-center py-12 xl:py-0">
                <motion.div 
                    initial={{opacity: 0}} 
