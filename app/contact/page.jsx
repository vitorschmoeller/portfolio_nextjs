...
const info = [
    {
        icon: <FaPhoneAlt />,
        title: 'Phone',
        description: "+55 (81) 996660230"
    },
    {
        icon: <FaEnvelope />,
        title: 'Email',
        description: "vitorschmoeller2000@gmail.com"
    },
    {
        icon: <FaMapMarkedAlt />,
        title: 'Address',
        description: "Brazil, Pernambuco, Camaragibe"
    },
]
                    ...
                    <div className="xl:w-[54%] order-2 xl:order-none">
                        <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
                            ...
                            <p className="text-white/60">
                                ...
                                blanditiis molestiae iste sed officia. Fugiat dicta voluptates blanditiis 
                                eos. Velit nostrum nam ex nemo ducimus cum eveniet, est numquam!
                            </p>
